import { actions, types } from 'routes/Counter/counterActions'
...
describe('(Redux Module) Counter', () => {
  it('Should export a constant COUNTER_INCREMENT.', () => {
    expect(types.COUNTER_INCREMENT).to.equal('COUNTER_INCREMENT')
  })
  ...
  describe('(Action Creator) increment', () => {
    ...
    it('Should return an action with type "COUNTER_INCREMENT".', () => {
      expect(actions.increment()).to.have.property('type', types.COUNTER_INCREMENT)
    })
